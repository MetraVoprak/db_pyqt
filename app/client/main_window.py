    ...
    def history_list_update(self):
        ...
        for i in range(start_index, length):
            ...
            if item[1] == 'in':
                ...
                mess.setSelectable(False)
                gradient = QLinearGradient(0, 0, 0, 1)
                gradient.setColorAt(0.0, QColor('#ffa02f'))
                gradient.setColorAt(1.0, QColor('#ca0619'))
                mess.setBackground(QBrush(gradient))
                ...
                gradient = QLinearGradient(0, 0, 0, 1)
                gradient.setColorAt(0.0, QColor('#ffa02f'))
                gradient.setColorAt(1.0, QColor('#278a25'))
                mess.setBackground(QBrush(gradient))
                self.history_model.appendRow(mess)
